...
#endif
{
	...
	z  = x;  
	FD_LO(z) = 0;
	r  =  __ieee754_exp(gS(gM(-z,z), 0.5625))*__ieee754_exp(gA(gM(gS(z,x),gA(z,x)), gD(r2,S)));
...
#endif
{
	...
	if (ix < 0x403c0000) {		/* |x|<28 */
	    ...
	    z  = x;
	    FD_LO(z)  = 0;
	    r  =  gA(gM(__ieee754_exp(gS(gM(-z,z), 0.5625)), __ieee754_exp(gM(gS(z,x),gA(z,x)))), gD(r2,S));
